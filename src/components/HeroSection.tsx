        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20 pointer-events-none px-4">
          <div className="scroll-reveal text-center">
            ...
            <div className="mt-6 pointer-events-auto">
              <button className="bg-foreground text-primary-foreground font-display font-semibold rounded-full px-8 py-3 text-sm hover:-translate-y-0.5 hover:shadow-xl transition-all duration-300 inline-flex items-center gap-2">
